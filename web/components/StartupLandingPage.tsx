        ...
        <nav className="fixed top-0 w-full z-50 bg-black/95 backdrop-blur-sm border-b border-white/10 text-white">
            <div className="max-w-[1400px] mx-auto px-6 h-20 flex items-center justify-between">
                ...
                <div className="flex items-center gap-4">
                    ...
                    <SmartCTAButton role="startup" loggedInHref="/startup/dashboard" guestHref="/startup/dashboard/login?view=signup&role=startup" className="px-6 py-2 bg-white text-black text-xs font-bold uppercase tracking-widest hover:bg-gray-200 transition-colors">
                        Start Delegating
                    </SmartCTAButton>
                </div>
            </div>
            ...
            <div className="flex-none flex flex-col items-center text-center w-full mb-12 max-w-[1400px] mx-auto px-6 z-10 relative">
                <FadeIn>
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-center">
                        <SmartCTAButton role="startup" loggedInHref="/startup/dashboard" guestHref="/startup/dashboard/login?view=signup&role=startup" className="h-14 px-8 bg-white text-black text-xs font-bold uppercase tracking-widest hover:bg-gray-200 transition-colors flex items-center justify-center">
                            Post First Drop
                        </SmartCTAButton>
