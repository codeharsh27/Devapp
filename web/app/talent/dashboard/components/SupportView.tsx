        ...
        <div className="max-w-4xl mx-auto p-8 text-white animate-in fade-in duration-500">
            ...
            <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-[#111113] border border-zinc-800 rounded-2xl p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                            Need help with a submission or having account trouble? Reach out to our support team.
                        </p>
                ...
                <div className="bg-[#111113] border border-zinc-800 rounded-2xl p-8 space-y-6">
                    ...
                    <div>
                        ...
                        <p className="text-zinc-400 text-sm leading-relaxed mb-6">
                            Connect with other developers. Share your wins, find teammates, and level up together.
                        </p>
            ...
            <div className="mt-12">
                ...
                <div className="grid gap-4">
                    {[
                        { q: "How do I get paid?", a: "Payments are processed securely once your submission is accepted by the startup. We currently support varied payout methods." },
                        { q: "Can I work on multiple missions?", a: "Yes! You can enroll in multiple missions, but we recommend focusing on 1-2 to ensure high quality delivery." },
                        { q: "What if a startup doesn't respond?", a: "If a submission is pending for over 7 days, our support team will intervene to ensure you get a timely evaluation." }
                    ].map((faq, i) => (
